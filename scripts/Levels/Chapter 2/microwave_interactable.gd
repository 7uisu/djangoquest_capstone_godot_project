#microwave_interactable.gd
extends Area2D

@export var interaction_text: String = "(F) to Talk"
@onready var interaction_label: Label = $Label
@onready var animated_sprite_2d: AnimatedSprite2D = $AnimatedSprite2D # Added this line
@export var show_once: bool = false

var has_interacted: bool = false
var player_is_inside: bool = false
var player_node: Node2D = null
var dialogue_ui_path: NodePath = NodePath("/root/Playground/UILayer/MicrowaveInteractionDialogue")
...
func _ready() -> void:
	...
	# Play the "idle" animation when the node is ready
