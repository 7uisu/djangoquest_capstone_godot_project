# room_contact_function_minigame_1.gd
extends Control
...
func go_to_next_minigame():
	...
	get_tree().change_scene_to_file("res://Minigame Scenes and Scripts/Chapter 2/chapter_2_world_part_4_1st_minigame_pt3.tscn")
