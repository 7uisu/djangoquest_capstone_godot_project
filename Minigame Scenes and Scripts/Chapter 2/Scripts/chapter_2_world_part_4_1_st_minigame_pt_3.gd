#chapter_2_world_part_4_1st_minigame_pt3.gd
extends Node2D

@onready var delivery_bot = $YSortLayer/DeliveryBot1
@onready var player = $Player
@onready var instructions_ui = $UILayer/Chapter2Minigame1Instructions

@onready var player_camera = $Player/Camera2D 
@onready var delivery_bot_camera = $YSortLayer/DeliveryBot1/Camera2D 
...
func setup_minigame():
	...
	if delivery_bot and is_instance_valid(delivery_bot):
		...
		print("Chapter2Minigame1: DeliveryBot1 movement enabled.")
	else:
		printerr("Chapter2Minigame1: DeliveryBot1 node not found or invalid!")
...
func minigame_completed():
	...
	if delivery_bot:
		...
		print("Chapter2Minigame1: DeliveryBot1 movement disabled.")
