...
func _ready():
	...
	print("DeliveryBot1: _ready called. Initial can_move:", can_move)
...
func create_trail_point(pos: Vector2) -> Node:
	...
	trail_point.color = Color.DODGER_BLUE  # blue color
...
func enable_movement():
	can_move = true
	print("DeliveryBot1: enable_movement() called. can_move is now:", can_move)
...
func disable_movement():
	...
	print("DeliveryBot1: disable_movement() called. can_move is now:", can_move)
...
func reset_position_and_trail():
	...
	last_trail_position = global_position
	print("DeliveryBot1: reset_position_and_trail() called. Position reset.")
