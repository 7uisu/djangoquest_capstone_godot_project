# room_about_function_minigame_1.gd
extends Control
...
func complete_quiz():
	...
	feedback_label.text = "Fact: 'urlpatterns' is a list\nthat connects URLs to views."
	feedback_label.modulate = Color.GREEN
...
func go_to_next_minigame():
	...
	get_tree().change_scene_to_file("res://Minigame Scenes and Scripts/Chapter 2/chapter_2_world_2nd_minigame_pt1.tscn")
